...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      <?php
          ...
          ?>
      <div class="button1">
      <button type="button"style="margin-top:570px;margin-left:1350px;width:150px;background: #aa8453;color: white; hight:120px; background-attachment: relative;">Book Now</button>
      </div>
      <div class="button2">
      <button type="button" style="margin-top:580px; margin-left:330px; width:150px;background: #aa8453;color: white; hight:120px;  background-attachment: relative;">Book Now</button>
      </div>
      <div class="button3">
      <button type="button" style="margin-top:580px; margin-left:1400px; width:150px;background: #aa8453;color: white; hight:120px;  background-attachment: relative;">Book Now</button>
      </div>
      <div class="button4">
      <button type="button" style="margin-top:580px; margin-left:330px; width:150px;background: #aa8453;color: white; hight:120px;  background-attachment: relative;">Book Now</button>
      </div>
...
<select class="select2 select" style="border:none;border-bottom: 7px solid #aa8453;width: 100%; height:100%;">
...
<div class="select1_wrapper">
<div class="select1_inner">
<select class="select2 select" style="border:none;border-bottom: 7px solid #aa8453;width: 100%;height:100%;margin-top:-78px;margin-left:250px;">
...
<div class="select1_wrapper">
<div class="select1_inner">
<select class="select2 select" style="border:none;border-bottom: 7px solid #aa8453;width: 100%;height:100%;margin-top:-78px;margin-left:500px;">
