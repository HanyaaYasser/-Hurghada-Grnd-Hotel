...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="styles/conf_rej_wait1.css">
        ...
        <script>
            ...
            if(val.length == 0)
            {
                ...
                {
                jQuery.ajax({
                            url: "includes/func/get_search_wait_res.php",
                            data: 'val=' + val,
                            type: "POST",
    ...
    <body>
        ...
        <div class = "rooms_in_reservation">
            ...
            <?php
                $sql_get_res_id = "select ReservationId FROM tbl_reservation where ReservationConfirmation = 'Waiting'";
                    ...
                    while($row_res_id = $result_res_id->fetch_array())
                    {
                        ...
                        echo "<div class = \"card\">
                                ...
                                <a href = \"modify_rooms_2.php?ReservationId=". $row_res_id['ReservationId'] ."\">
                                    ...
                                    <div class = \"name_mail\">
                                        <a href = \"conf_rej_wait_res2.php?ReservationId=". $row_res_id['ReservationId'] ."\">
